...
% Check that version of MATLAB is 8.5 (R2015a)
if verLessThan('matlab', '8.5')
    error('MATLAB 8.5 (R2015a) or higher is required.');
elseif ~verLessThan('matlab', '8.6')
    warning('It is recommended to work with MATLAB 8.5 (R2015a).')
end
...
addInPath(fullfile(root_dir,'lib')) % Librairy of drivers for Robot
